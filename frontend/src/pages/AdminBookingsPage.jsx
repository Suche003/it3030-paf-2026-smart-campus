    ...
    <div className="admin-bookings-container">
        ...
        <div className="analytics-panel">
          ...
          <div className="analytics-stats">
            ...
            <div className="stat-card approved">
              <div className="stat-value">{analytics.approved}</div>
            ...
            <div className="stat-card rejected">
              <div className="stat-value">{analytics.rejected}</div>
              <div className="stat-label">❌ Rejected</div>
            </div>
            <div className="stat-card cancelled">
              <div className="stat-value">{analytics.cancelled}</div>
      ...
      <div className="filter-section">
        <div className="filter-buttons">
          ...
          >
            All <span className="count">{getCount('ALL')}</span>
          </button>
          <button 
            className={`filter-chip pending ${activeFilter === 'PENDING' ? 'active' : ''}`}
            onClick={() => setActiveFilter('PENDING')}
          >
            ⏳ Pending <span className="count">{getCount('PENDING')}</span>
          </button>
          <button 
            className={`filter-chip approved ${activeFilter === 'APPROVED' ? 'active' : ''}`}
            onClick={() => setActiveFilter('APPROVED')}
          >
            ✅ Approved <span className="count">{getCount('APPROVED')}</span>
          </button>
          <button 
            className={`filter-chip rejected ${activeFilter === 'REJECTED' ? 'active' : ''}`}
            onClick={() => setActiveFilter('REJECTED')}
          >
            ❌ Rejected <span className="count">{getCount('REJECTED')}</span>
          </button>
          <button 
            className={`filter-chip cancelled ${activeFilter === 'CANCELLED' ? 'active' : ''}`}
            onClick={() => setActiveFilter('CANCELLED')}
          >
            🚫 Cancelled <span className="count">{getCount('CANCELLED')}</span>
          </button>
        </div>
        ...
        <div className="modal-overlay" onClick={() => setShowRejectModal(null)}>
          <div className="modal-container" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-body">
              ...
              <textarea
                placeholder="Example: Resource unavailable, Time slot conflict, Invalid request..."
                value={rejectReason}
            ...
            <div className="modal-footer">
              ...
              <button className="modal-confirm" onClick={() => handleReject(showRejectModal)}>
                Confirm Reject
              </button>
            </div>
          </div>
